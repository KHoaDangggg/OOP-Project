package crawl_data.crawl_trieu_dai;

import crawl_data.model.trieu_dai.KinhDo;
import crawl_data.model.trieu_dai.QuocHieu;
...
public class CrawlTrieuDai {
    ...
    static void crawlTrieuDai() {
        WebElement div = CrawlTrieuDai.crawlHTML("https://baoduongmaynenkhi.vn/tom-tat-lich-su-viet-nam/", 1, "section.post_content.clearfix");
