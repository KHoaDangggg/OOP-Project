...
public class CrawlAnhHungVuTrangManager {
    private final List<AnhHungVuTrang> dsAnhHung = new ArrayList<>();
    ...
    private void saveToJson() {
        try {
            ...
            objectMapper.writeValue(new File("src/JSON_Data/vuTrang.json"), dsAnhHung);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
