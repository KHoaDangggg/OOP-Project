...
public class CrawlTrieuDaiManager {
    ...
    private void crawlTrieuDai() {
        WebElement div = crawlHTML("https://baoduongmaynenkhi.vn/tom-tat-lich-su-viet-nam/", 1, "section.post_content.clearfix");
    ...
    private void crawlQuocHieu() {
        ...
        for (int i = 0; i < 23; i++) {
            ...
            if (newQuocHieu != null && newQuocHieu.getNamKetThuc().contains("CN") && !newQuocHieu.getNamKetThuc().contains("TCN")) {
    ...
    private void addPropertiesToTrieuDai() {
    ...
    private boolean isMatch(String... years) {
        int[] nam = new int[4];
        for (int i = 0; i < 4; i++) {
            String year = years[i];
    ...
    private WebElement crawlHTML(String url, Integer waitSecond, String waitElement) {
        ...
        return driver.findElement(By.cssSelector(waitElement));
    }
}