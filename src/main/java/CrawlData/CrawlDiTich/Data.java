    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (String[] heritage : heritageList) {
                System.out.println("Tên: " + heritage[0]);
                System.out.println("Địa điểm: " + heritage[1]);
                System.out.println("Loại di tích: " + heritage[2]);
                System.out.println("Năm công nhận: " + heritage[3]);
                System.out.println("Mô tả: " + heritage[4]);
                System.out.println("-------------------");
            }
           ...
           /* try (FileWriter file = new FileWriter("heritage2.json")) {
            ...
            try (FileWriter file = new FileWriter("heritage4.json")) {
                ...
                for (String[] heritage : heritageList) {
                    ...
                    jsonObject.put("Địa điểm", heritage[1]);
                    jsonObject.put("Loại di tích", heritage[2]);
                    jsonObject.put("Năm công nhận", heritage[3]);
                    jsonObject.put("Mô tả", heritage[4]);
