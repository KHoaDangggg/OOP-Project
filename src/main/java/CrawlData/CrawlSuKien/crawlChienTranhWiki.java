...
public class crawlChienTranhWiki {
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<ArrayList> events = new ArrayList<>();
        ArrayList<ArrayList> listtenNhanVatLienQuan = new ArrayList<>();
        ArrayList<ArrayList> listtenTrieuDaiLienQuan = new ArrayList<>();
        ...
        for(int i=0;i < events.size();i++){
            ...
            String time = thoiGianDienRa(events.get(i).get(0).toString());
            chienTranh.setTenSuKien(events.get(i).get(0).toString());
            chienTranh.setThoiGian(time);
            chienTranh.setPheTa(events.get(i).get(1).toString().replaceAll("\"",""));
            chienTranh.setPheDich(events.get(i).get(2).toString());
            chienTranh.setKetQua(events.get(i).get(3).toString());
        ...
        /*
        file.write(chienTranhVN.toString());
        file.flush();
        file.close();

         */
    }
    public static String thoiGianDienRa(String time){
