...
public class crawlThuVienLichSu {
    public static void main(String[] args) throws IOException {
        ...
        for (String link_event : link_events) {
            SuKienChienTranh suKien = new SuKienChienTranh();
            suKien.createObject();
            ...
            suKien.setTenSuKien(headers.get(0).text());
        ...
        try{
            FileWriter fileWriter = new FileWriter("src/JSON_Data/SuKien.json");
    ...
    public static int namDienra(String time) throws  IOException{
        int nam;
